...
urlpatterns = [
    path('<str:group>/', base_views.list, name='list'),
    path('detail/<int:board_id>/', base_views.detail, name='detail'),
    path('create/<str:group>/', board_views.board_create, name='board_create'),
    path('modify/<int:board_id>/', board_views.board_modify, name='board_modify'),
    path('delete/<int:board_id>/', board_views.board_delete, name='board_delete'),
